...
import { extractGroupControllerProps } from "./extractGroupControllerProps";
import {
  type IBaseHookFormPFGroupControllerProps,
  HookFormPFGroupController,
} from "./HookFormPFGroupController";

interface IWithIntegerType extends Omit<TextInputProps, "type"> {
...
> = IWithIntegerType & IBaseHookFormPFGroupControllerProps<TFieldValues, TName>;
